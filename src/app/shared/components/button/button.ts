...
import { cx } from '@/shared/utils/ckassnames'
...
export class Button implements OnInit {
  ...
  baseClasses =
    'font-semibold focus-visible:outline-none flex items-center justifi-center focus-visible:ring-2 focus-visible:ring-offset-2 active:translate-y-px disabled:pointer-events-none disabled:opacity-50'

  impactClasses: Record<ButtonProps['tone'], Record<ButtonProps['impact'], string>> = {
    primary: {
      bold: 'bg-primary text-primary-foreground hove:bg-primary/90 focus-visible:ring-primary',
